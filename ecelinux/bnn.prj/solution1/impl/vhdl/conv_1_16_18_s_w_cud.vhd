...
entity conv_1_16_18_s_w_cud_rom is 
    generic(
             DWIDTH     : integer := 1; 
             AWIDTH     : integer := 8; 
...
architecture rtl of conv_1_16_18_s_w_cud_rom is 
...
signal mem : mem_array := (
    ...
    135 to 136=> "0", 137 to 139=> "1", 140 => "0", 141 to 142=> "1", 143 => "0" );
...
entity conv_1_16_18_s_w_cud is
    generic (
        DataWidth : INTEGER := 1;
...
architecture arch of conv_1_16_18_s_w_cud is
    component conv_1_16_18_s_w_cud_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    conv_1_16_18_s_w_cud_rom_U :  component conv_1_16_18_s_w_cud_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
