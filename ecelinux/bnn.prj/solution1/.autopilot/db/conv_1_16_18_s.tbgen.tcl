...
set C_modelArgList {
	{ input_0 int 1 regular {array 324 { 1 3 } 1 1 }  }
	{ output_r int 1 regular {array 4096 { 0 3 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.threshold_conv1_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.w_conv1_0_U", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "143921", "Max" : "143921"}
	, {"Name" : "Interval", "Min" : "143921", "Max" : "143921"}
]}
...
set Spec2ImplPortList { 
	...
	output_r { ap_memory {  { output_r_address0 mem_address 1 12 }  { output_r_ce0 mem_ce 1 1 }  { output_r_we0 mem_we 1 1 }  { output_r_d0 mem_din 1 1 } } }
}
