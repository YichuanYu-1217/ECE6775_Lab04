set moduleName initialize_padded_me
set isTopModule 0
...
set C_modelName {initialize_padded_me}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_r int 1 regular {array 1600 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_r", "interface" : "memory", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ input_r_d0 sc_out sc_lv 1 signal 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_r_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "input_r", "role": "d0" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1953", "Max" : "1953"}
	, {"Name" : "Interval", "Min" : "1953", "Max" : "1953"}
]}
...
set Spec2ImplPortList { 
	input_r { ap_memory {  { input_r_address0 mem_address 1 11 }  { input_r_ce0 mem_ce 1 1 }  { input_r_we0 mem_we 1 1 }  { input_r_d0 mem_din 1 1 } } }
}
